    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-dn-steel-lt via-white to-dn-steel-lt px-4">
      <div className="text-center space-y-8 max-w-md">
        <div className="space-y-4">
          <h1 className="text-8xl font-bold text-dn-steel">404</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
          ...
          <button
            ...
            className="px-8 py-3 rounded-lg border-2 border-dn-steel text-dn-steel font-medium hover:bg-dn-steel hover:text-white transition-colors"
          >
            Go Back
          </button>
        </div>
        ...
        <div className="pt-8 border-t border-dn-steel-lt">
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link to="/" className="text-dn-steel hover:underline">
                Landing Page
              </Link>
            </li>
            <li>
              <Link to="/login" className="text-dn-steel hover:underline">
                Sign In
              </Link>
            </li>
            <li>
              <Link to="/privacy" className="text-dn-steel hover:underline">
                Privacy Policy
              </Link>
            </li>
          </ul>
